...
length = 1000
lights = [[0 for i in range(length)] for j in range(length)]
...
for line in input.splitlines():
    ...
    if len(command) == 4:
        x_1, y_1 = re.split(',', command[1])
        x_2, y_2 = re.split(',', command[3])
        ...
        x_1, y_1 = re.split(',', command[2])
        x_2, y_2 = re.split(',', command[4])
